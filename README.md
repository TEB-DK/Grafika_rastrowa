...
<details>
  ...
  - [Instalacja i konfiguracja Photoshopa](#instalacja-adobe-photoshop)
...
<details>
  ...
  - [Panel narzędzi](#panel-narzędzi)
    
  - [Panele i okna](#panele-i-okna)
...
<details>
  ...
  - [Tworzenie nowego dokumentu](#tworzenie-nowego-dokumentu)
    
  - [Otwieranie i zapisywanie plików](#otwieranie-i-zapisywanie-plików)
    
  - [Rozmiar i rozdzielczość obrazu](#rozmiar-i-rozdzielczość-obrazu)
    
  - [Przeglądanie historii i tworzenie migawek](#przeglądanie-historii-i-tworzenie-migawek)
...
<details>
  ...
  - [Narzędzia wyboru](#narzędzia-wyboru)
    
  - [Malowanie i rysowanie](#malowanie-i-rysowanie)
    
  - [Retuszowanie i poprawianie błędów](#retuszowanie-i-poprawianie-błędów)
    
  - [Filtry i efekty specjalne](#filtry-i-efekty-specjalne)
...
<details>
  ...
  - [Tworzenie i zarządzanie warstwami](#)
    
  - [Wykorzystanie maski warstwy](#)
    
  - [Grupowanie warstw i efekty warstwowe](#)
...
<details>
  ...
  - [Korygowanie jasności i kontrastu](#)
...
<details>
  ...
  - [Poprawa ostrości i rozmycia](#)
    
  - [Klonowanie i usuwanie obiektów](#)
...
> Te palety i okna oraz skróty klawiszowe są istotnymi elementami interfejsu Photoshopa, które pozwalają na bardziej zaawansowaną i efektywną pracę z grafiką rastrową. Ich dostosowywanie i umiejętne wykorzystywanie może znacząco przyspieszyć proces projektowania i edycji.
...
5. **Dodawanie zdjęć i grafik:** Jeśli jest to konieczne, uczestnik może dodać zdjęcia lub grafiki związane z wydarzeniem lub artystami. Photoshop pozwala na edycję i dostosowanie tych elementów do projektu.
